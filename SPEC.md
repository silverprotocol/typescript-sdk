...
A conformant normalizer ships fixtures asserting the items below; items that name a reducer or a consuming ingest (1, 2, 20, 22) bind those implementations instead:
